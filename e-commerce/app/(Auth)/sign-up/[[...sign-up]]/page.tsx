    ...
    <div className="min-h-screen w-full flex items-center justify-center relative bg-[#E7F0DC]/30">
      ...
      <div className="w-full max-w-6xl h-[700px] mx-4 relative flex rounded-[30px] shadow-2xl shadow-color1/20 overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 bg-white/80 backdrop-blur-xl p-8 flex items-center justify-center relative">
          <div className="absolute top-0 left-0 w-32 h-32 bg-color1/10 rounded-br-full"></div>
          <div className="absolute bottom-0 right-0 w-40 h-40 bg-color1/5 rounded-tl-full"></div>
        ...
        {/* Right Side - Image */}
        <div className="hidden lg:flex w-1/2 relative bg-gradient-to-bl from-color1/90 via-color1 to-color1/80">
          {/* Decorative Elements */}
